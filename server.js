...
// Check if built in D:\FlocksensePrediction or local build
const candidateDirs = [
  path.join(__dirname, 'build', 'web'),
  path.join(__dirname, '..', 'build', 'web'),
  'D:\\FlocksensePrediction\\build\\web',
];

let PUBLIC_DIR = candidateDirs.find(dir => fs.existsSync(dir)) || candidateDirs[0];
