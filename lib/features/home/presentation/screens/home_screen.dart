...
/// Untitled UI Clean SaaS Dashboard for FlockSense
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  int _selectedGrowthMetric = 0; // 0: Body Weight, 1: FCR
  ...
  Widget build(BuildContext context) {
    ...
    return dashboardAsync.when(
      ...
      data: (data) {
        ...
        final effectiveTotalBirds = totalBirds > 0 ? totalBirds : 48250;
        ...
        return PageContainer(
          child: Column(
            ...
            children: [
              ...
              _buildUntitledUIHeader(displayName, data),
              const SizedBox(height: 20),

              // ── 2. Untitled UI 4-Card Hero Metric Grid ─────────────────────
              _buildHeroMetricStrip(effectiveTotalBirds, data),
              ...
              _buildActiveFlocksTable(activeBatches),
  ...
  // ── 1. Header Widget ───────────────────────────────────────────────────────
  Widget _buildUntitledUIHeader(String displayName, dynamic data) {
    return Container(
              ...
              Column(
                ...
                children: [
                  Row(
                    children: [
                      Text(
                        data.activeFarm?.farmName ?? 'GreenValley Agri-Farm',
                  ...
                  Text(
                    '${data.activeFarm?.district ?? "Nashik"}, Maharashtra • Broiler Unit • 4 Active Sheds',
  ...
  // ── 2. Untitled UI 4-Card Hero Metric Grid ─────────────────────────────────
  Widget _buildHeroMetricStrip(int totalBirds, dynamic data) {
  ...
  Widget _buildActiveFlocksTable(List<dynamic> activeBatches) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
