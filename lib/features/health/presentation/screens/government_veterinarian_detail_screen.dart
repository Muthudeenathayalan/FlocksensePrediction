            ...
            child: Row(
              children: [
                InkWell(
                  ...
                  child: const Text('Veterinary Network', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: AppColors.primary)),
                ),
                ...
                Text(_vet.district, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: AppColors.primary)),
                const Padding(padding: EdgeInsets.symmetric(horizontal: 6), child: Icon(Icons.chevron_right_rounded, size: 16, color: AppColors.slate400)),
                Text(_vet.name, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.slate900)),
              ],
            ),
          ),
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              return Wrap(
                ...
                runSpacing: 12,
                children: [
                  _buildKpiCard('Farms Covered', '${_vet.farmsCovered} Facilities', '${_vet.criticalFarms} Critical', AppColors.primary, itemWidth),
                  ...
                  _buildKpiCard('Diagnostic Lab Pipeline', '${_vet.labCases} Lab Tests', '${_vet.followUps} Follow-ups', AppColors.primary, itemWidth),
                ],
              );
            },
          ),
