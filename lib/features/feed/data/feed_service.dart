...
class FeedService {
  ...
  static Future<FeedTransactionModel> createFeedTransaction({
    ...
    final transactionId = 'feed_${DateTime.now().millisecondsSinceEpoch}';
  ...
  static Future<FeedTransactionModel> updateFeedTransaction({
    ...
    try {
      await transactionRef.set(updatedTransaction.toJson());
    } catch (_) {}
  ...
  static Stream<List<FeedTransactionModel>> watchFeedTransactions({
    ...
    return _feedTransactionsRef(uid, farmId, batchId)
  ...
  static List<FeedTransactionModel> get sampleTransactions => [
    FeedTransactionModel(
      ...
      costPerKg: 38.5,
      totalCost: 154000.0,
      supplierOrSource: 'Suguna Feed Mills, Namakkal',
      notes: 'Delivered in moisture-sealed bags. Quality inspected.',
    ),
    FeedTransactionModel(
      id: 'feed_tx_02',
      farmId: 'farm_01',
      ...
      transactionType: 'IN',
      feedType: 'Broiler Starter Crumbs',
      feedBatchNumber: 'FB-8840',
      dcNumber: 'DC-8704',
      bags: 60,
      weightPerBagKg: 50.0,
      totalKg: 3000.0,
      ...
      totalCost: 123000.0,
      supplierOrSource: 'Suguna Feed Mills, Namakkal',
      notes: 'Day 12-20 starter allocation.',
    ),
    FeedTransactionModel(
      id: 'feed_tx_03',
      farmId: 'farm_01',
      ...
      transactionType: 'IN',
      feedType: 'Pre-Starter Micro-Pellets',
      feedBatchNumber: 'FB-8610',
      dcNumber: 'DC-8550',
      bags: 40,
      weightPerBagKg: 50.0,
      totalKg: 2000.0,
      ...
      totalCost: 88000.0,
      supplierOrSource: 'Suguna Feed Mills, Namakkal',
      notes: 'Brooding phase starter ration.',
    ),
  ];
